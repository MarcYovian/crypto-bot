...
| :---: | :--- | :--- | :---: |
| **01** | [`01_app_setup_and_auth.md`](file:///home/rodex/Documents/cell/projects/crypto-bot/tasks/web_dashboard_api/01_app_setup_and_auth.md) | FastAPI Core Setup, JWT Security, In-Memory Async Cache (`AsyncInMemoryCache`), `/auth/login`, `/auth/refresh`, `/auth/me` | ⏳ Pending |
...
| **06** | [`06_signal_providers_and_strategies.md`](file:///home/rodex/Documents/cell/projects/crypto-bot/tasks/web_dashboard_api/06_signal_providers_and_strategies.md) | `/providers` (Cached), `/providers/{id}/analytics` (Cached TTL 30s), `/strategies` (Cached) | ⏳ Pending |
...
| **08** | [`08_bot_operations_and_settings.md`](file:///home/rodex/Documents/cell/projects/crypto-bot/tasks/web_dashboard_api/08_bot_operations_and_settings.md) | `/bot/status`, `/bot/pause`, `/bot/resume`, `/bot/panic`, `/settings` (Cached), `/credentials` | ⏳ Pending |
